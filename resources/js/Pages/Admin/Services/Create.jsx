...
export default function ServiceCreate() {
    ...
    return (
        <AdminLayout header="Tambah Alur SOP">
            <Head title="Tambah Alur SOP - Admin" />
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                        <div className="md:col-span-2">
                            <label className="block text-sm font-medium text-gray-700 mb-2">
                                Nama Alur SOP <span className="text-red-500">*</span>
                            </label>
                            <input
                                type="text"
                                value={data.name}
                        ...
                        <div className="md:col-span-2">
                            ...
                            <textarea
                                ...
                                placeholder="Masukkan detail informasi alur SOP perjalanan dinas..."
                            />
                ...
                <div className="flex justify-end gap-4">
                    ...
                    <button type="submit" disabled={processing} className="px-6 py-2 bg-sky-500 text-white rounded-lg hover:bg-sky-600 disabled:opacity-50">
                        {processing ? 'Menyimpan...' : 'Simpan Alur SOP'}
                    </button>
                </div>
            </form>
        </AdminLayout>
