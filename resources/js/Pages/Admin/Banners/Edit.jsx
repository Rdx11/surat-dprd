...
export default function BannerEdit({ banner }) {
    ...
    return (
        <AdminLayout header="Edit Banner">
                        ...
                        <div>
                            ...
                            {!preview ? (
                                <div className="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center">
                                    ...
                                    <p className="text-gray-600 mb-2">Upload gambar baru untuk mengganti (opsional)</p>
                                    <input
                                        type="file"
                                ...
                                <div className="relative">
                                    <p className="text-sm text-sky-600 mb-2">Gambar baru:</p>
                                    <img src={preview} alt="Preview" className="w-full max-w-2xl h-48 object-cover rounded-lg" />
                                    <button
                                        type="button"
                                        onClick={removeNewImage}
                                        className="absolute top-8 right-2 p-2 bg-red-500 text-white rounded-full hover:bg-red-600"
                                    >
                                        <X size={16} />
                                    </button>
                                </div>
